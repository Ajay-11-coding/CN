...
int main(){                                                                                                                                    
        ...
        serv_addr.sin_port = htons(6525);                                                                                                      
        serv_addr.sin_addr.s_addr = inet_addr("127.0.0.1");                                                                                    
                                                                                                                                               
        serv_addr2.sin_family = AF_INET;                                                                                                       
        serv_addr2.sin_port = htons(7510);                                                                                                     
...
R:                                                                                                                                             
                ...
                if(strncmp(buffer,"NULL",4)==0){                                                                                               
                        char cat[1000]={0};                                                                                                    
                        strcpy(cat,"Proxy server: ");                                                                                          
                        strcat(cat,d);                                                                                                         
                        write(connfd2,cat,strlen(cat));                                                                                        
}                                                                                                                                              
                else if (strncmp(buffer,"Last",4)==0){                                                                                         
                        update(url,buffer);                                                                                                    
                        char cat1[1000]={0};                                                                                                   
                        strcpy(cat1,"Origin server: ");
                        strcat(cat1,d);                                                                                                        
                        printf("%s\n",d);                                                                                                      
                        printf("%s\n",cat1) ;                                                                                                  
                        write(connfd2,cat1,strlen(cat1));                                                                                      
                }                                                                                                                              
                else                                                                                                                           
